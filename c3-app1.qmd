---
title: "Aplicación 3.1: Evaluación y validación del modelo de regresión lineal"
engine: knitr
excerpt: ""
draft: false
format: 
...
::: justify
# Ventas en una cadena de supermercados (datos de corte transversal) {.unnumbered}
...
::: justify
# El modelo APT de valoración de activos (datos de series temporales) {.unnumbered}
