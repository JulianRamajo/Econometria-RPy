...
::: justify
# Aplicación 2.5: Variaciones del modelo lineal básico {.unnumbered}

## Forma funcional polinómica: Curva de costes en el sector textil {.unnumbered}
...
Se estimará por MCO el siguiente modelo de regresión lineal asociado a la [curva de costes](https://en.wikipedia.org/wiki/Cost_curve) de la empresa:
...
::: justify
## Variables cualitativas: Brecha salarial entre hombres y mujeres en Estados Unidos {.unnumbered}
...
::: justify
## Variables de alta frecuencia y con estacionalidad: Demanda de electricidad en el estado de Victoria (Australia) {.unnumbered}
