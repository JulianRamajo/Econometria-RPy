---
title: "Aplicación 2.4: Predicciones"
engine: knitr
excerpt: ""
draft: false
format: 
...
En esta aplicación se estimará una [curva de Engel](https://es.wikipedia.org/wiki/Curva_de_Engel) que relaciona el gasto de las familias en alimentación ($GALIM$) con la renta disponible ($RENTA$), usando una muestra de 235 familias americanas:
